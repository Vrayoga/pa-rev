                ...
                <div class="auth-container">
                    ...
                    <div class="auth-side">
                        <div class="auth-side-content">
                            ...
                            <p class="auth-subtitle">Selamat datang di website Ekstrakurikuler SMKN 1 Sumenep</p>
                    ...
                    <div class="auth-form">
                        ...
                        <!-- User Type Selector (Hidden by default, can be enabled if needed) -->
                        <div class="user-type-selector d-none">
                            <button type="button" class="user-type-btn active" data-type="student">Siswa</button>
                            <button type="button" class="user-type-btn" data-type="teacher">Guru</button>
                        ...
                        <form method="POST" action="/login_action" class="forms-sample">
                            ...
                            {{-- <div class="d-flex justify-content-between align-items-center mb-4">
                                ...
                                <a href="/forgot-password" class="text-primary small">Lupa kata sandi?</a>
                            </div> --}}
                            ...
                            <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-2">
                                ...
                                <a href="/register" class="btn btn-outline-primary order-md-0">
