...
@section('content')
                                                    ...
                                                    @foreach ($ekstraGuru as $index => $ekstra)
                                                        @foreach ($ekstra->jadwals as $jadwal)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    @if ($jadwal->hari == strtolower($hariIni))
                                                                        @php
                                                                            $sesiHariIni = $jadwal
                                                                                ->sesiAbsen()
                                                                                ->whereDate(
    ...
    <form action="/absensi/buka" method="POST">
        ...
        <button type="submit" class="btn btn-primary btn-sm" 
            ${@json(session('tidak_boleh_buka')) ? 'disabled' : ''}>
            Buka Absen <i class="mdi mdi-arrow-right ms-1"></i>
        </button>
    </form>
    ${@json(session('tidak_boleh_buka')) ? '<small class="text-muted d-block mt-1">Sesi absensi hari ini sudah ditutup atau pernah dibuka.</small>' : ''}`;
