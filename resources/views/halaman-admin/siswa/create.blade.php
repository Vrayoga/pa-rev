                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input id="kelas" name="kelas" type="text" class="form-control" placeholder="Masukkan kelas">
                                    </div>
                                    <div class="mb-3">
                                        <label for="nis">NIS</label>
                                        <input id="nisn" name="nisn" type="text" class="form-control" placeholder="Masukkan NIS">
                                    </div>
                                    <div class="mb-3">
