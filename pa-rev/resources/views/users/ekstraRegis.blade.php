            ...
            <div class="col-12">
                <div class="d-flex align-items-center justify-content-between">
                    <div>
                        ...
                        <p class="lead text-muted">Bergabunglah dengan kegiatan ekstrakurikuler pilihan Anda (maksimal 2)</p>
                    </div>
                    <div>
                        ...
                        <div class="pending-list">
                            ...
                            <div class="pending-item">
                                ...
                                <div class="pending-details">
                                    ...
                                    <p class="text-muted mb-2">Tanggal Pendaftaran: {{ $pending->created_at->format('d F Y H:i') }}</p>
                        ...
                        <form id="pendaftaranForm" action="{{ route('ekstraDaftar.store') }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" value="{{ Auth::user()->kelas_siswa->nama_kelas ?? '-' }}" readonly>
                                    </div>
                                </div>
                            </div>

                            <div class="mb-4">
                                <label for="nomer_wali" class="form-label">Nomor Telepon Wali <span class="text-danger">*</span></label>
                                <input type="text" class="form-control @error('nomer_wali') is-invalid @enderror" id="nomer_wali" name="nomer_wali" placeholder="Masukkan nomor telepon wali murid" value="{{ old('nomer_wali') }}" required>
                                @error('nomer_wali')
                            ...
                            <div class="card mb-4 border-primary bg-light bg-opacity-10">
                                <div class="card-header bg-primary bg-opacity-10">
                                    <h5 class="mb-0">Pilihan Ekstrakurikuler 1 <span class="text-danger">*</span></h5>
                                </div>
                                <div class="card-body">
                                    <div class="mb-4">
                                        <label for="ekstrakurikuler_id_1" class="form-label">Ekstrakurikuler <span class="text-danger">*</span></label>
                                        <select class="form-select select2 @error('ekstrakurikuler_id_1') is-invalid @enderror" id="ekstrakurikuler_id_1" name="ekstrakurikuler_id_1" required>
                                            ...
                                            <option value="{{ $ekstra->id }}" 
                                                ...
                                                - Kuota: {{ is_numeric($sisaKuota) ? $sisaKuota : $sisaKuota }}
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control @error('alasan_1') is-invalid @enderror" id="alasan_1" name="alasan_1" rows="3" placeholder="Jelaskan alasan Anda ingin bergabung dengan ekstrakurikuler ini (opsional)">{{ old('alasan_1') }}</textarea>
                                        @error('alasan_1')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="card mb-4 border-success bg-light bg-opacity-10">
                                <div class="card-header bg-success bg-opacity-10 d-flex justify-content-between align-items-center">
                                    <h5 class="mb-0">Pilihan Ekstrakurikuler 2 <span class="text-muted">(Opsional)</span></h5>
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="toggleEkstra2" {{ old('ekstrakurikuler_id_2') ? 'checked' : '' }}>
                                        <label class="form-check-label" for="toggleEkstra2">Aktifkan</label>
                                    </div>
                                </div>
                                <div class="card-body" id="ekstra2Section" style="{{ old('ekstrakurikuler_id_2') ? '' : 'display: none;' }}">
                                    <div class="mb-4">
                                        <label for="ekstrakurikuler_id_2" class="form-label">Ekstrakurikuler</label>
                                        <select class="form-select select2 @error('ekstrakurikuler_id_2') is-invalid @enderror" id="ekstrakurikuler_id_2" name="ekstrakurikuler_id_2">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control @error('alasan_2') is-invalid @enderror" id="alasan_2" name="alasan_2" rows="3" placeholder="Jelaskan alasan Anda ingin bergabung dengan ekstrakurikuler ini (opsional)">{{ old('alasan_2') }}</textarea>
                                        @error('alasan_2')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="alert alert-info">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <p class="mb-0">Anda dapat memilih maksimal 2 ekstrakurikuler. Pilihan pertama wajib diisi, sedangkan pilihan kedua bersifat opsional.</p>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="card premium-card sticky-top" style="top: 20px;">
                    ...
                    <div class="card-body">
                        <div class="text-center mb-4" id="ekstraImagePreview">
                            <img src="{{ asset('assets/images/ekstra/default.jpg') }}" alt="Preview Ekstrakurikuler" class="img-fluid rounded" style="max-height: 180px; width: auto;" id="ekstraImage">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <p id="ekstraDeskripsi" class="text-justify">Pilih ekstrakurikuler untuk melihat deskripsi lengkap</p>
                        </div>
                    </div>
                </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        $('#pendaftaranForm').on('submit', function(e) {
            ...
            if(!ekstra1) {
                e.preventDefault();
                alert('Pilihan Ekstrakurikuler 1 wajib diisi!');
                return false;
            }
